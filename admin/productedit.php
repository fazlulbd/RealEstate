         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="kitchen" value="<?php echo $value['kitchen'] ?>" class="medium" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="bedroom" value="<?php echo $value['bedroom'] ?>" class="medium" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="bathroom" value="<?php echo $value['bathroom'] ?>" class="medium" />
                    </td>
                </tr>
