	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Why buy from us</h4>
						...
						<li><a href="map.php"><span>Site Map</span></a></li>
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>My account</h4>
						<ul>
							...
							<li><a href="cart.php">View booking</a></li>
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contact</h4>
						<ul>
							<li><span>+88-01779795618</span></li>
							<li><span>+88-01779795618</span></li>
						</ul>
						<div class="social-icons">
							<h4>Follow Us</h4>
					   		  <ul>
							      <li class="facebook"><a href="www.facebook.com" target="_blank"> </a></li>
							      <li class="twitter"><a href="www.twitter.com" target="_blank"> </a></li>
							      <li class="googleplus"><a href="www.google.com" target="_blank"> </a></li>
			...
			<div class="copy_right">
				<p>Dream Life Real Estate &amp; All rights Reseverd </p>
		   </div>
     </div>
    </div>
