...
<!DOCTYPE HTML>
<head>
<title>Dream Life Real Estate</title>
...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php"><img src="images/a.png" alt="" /></a>
       <h1>DREAM LIFE REAL ESTATE</h1>
      </div>
        <div class="header_top_right">
          ...
          <div class="cart">
            <a href="#" title="View my shopping cart" rel="nofollow">
                <span class="cart_title">Booking</span>
...
<div class="menu">
  <ul id="dc_mega-menu-orange" class="dc_mm-orange">
    ...
    <?php 
      ...
      if ($chkCart) {
          ?>
        <li><a href="cart.php">Booking</a></li>
