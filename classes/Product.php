...
class Product
{
    ...
    public function productInsert($data, $file)
    {
        ...
        $bedroom     = $this->fm->validation($data['bedroom']);
        $bathroom    = $this->fm->validation($data['bathroom']);
        ...
        $kitchen     = mysqli_real_escape_string($this->db->link, $kitchen);
        $bedroom     = mysqli_real_escape_string($this->db->link, $bedroom);
        $bathroom    = mysqli_real_escape_string($this->db->link, $bathroom);
        ...
        if (empty($file_name)) {
            ...
            $query = "INSERT INTO tbl_product(productName, catId, brandId, body, price,kitchen,bedroom,bathroom, image, type) VALUES('$productName', '$catId', '$brandId', '$body', '$price','$kitchen','$bedroom','$bathroom', '$uploaded_image', '$type')";
    ...
    public function productUpdate($data, $file, $proid)
    {
        ...
        if ($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" || $type == "" || $kitchen == "" || $bedroom == "" || $bathroom == "") {
            $msg = "<span class='error'>Fields must not be empty!</span>";
            return $msg;
        } else {
            if (!empty($file_name)) {
    ...
    public function insertCompareDara($cmprid, $cmrId)
    {
        ...
        if ($result) {
            ...
            $query = "INSERT INTO tbl_compare(cmrId, productId, productName, price,kitchen,bedroom,bathroom, image) VALUES('$cmrId', '$productId', '$productName', '$price','$kitchen','$bedroom','$bathroom', '$image')";
            $inserted_row = $this->db->insert($query);
            if ($inserted_row) {
    ...
    public function saveWishListData($proId, $cmrId)
    {
        ...
        if ($result) {
            ...
            $query = "INSERT INTO tbl_wlist(cmrId, productId, productName, price,kitchen,bedroom,bathroom, image) VALUES('$cmrId', '$productId', '$productName', '$price','$kitchen','$bedroom','$bathroom', '$image')";
            $inserted_row = $this->db->insert($query);
            if ($inserted_row) {
