			...
			<div class="cont-desc span_1_of_2">
				...
				<div class="desc span_3_of_2">
					...
					<div class="price">
						...
						<p>City:<span><?php echo $result['brandName']; ?></span></p>
						<p>Kitchen:<span><?php echo $result['kitchen']; ?></span></p>
						<p>Bedroom:<span><?php echo $result['bedroom']; ?></span></p>
						<p>Bathroom:<span><?php echo $result['bathroom']; ?></span></p>
			    	</div>
					<div class="add-cart">
